...
async def download_video(ult):
    ...
    CAPT = f"  🔅 ⃟ ▬▬▬▬▬▬▬▬▬▬ ⃟  🔅\n\n     🎸𝐌𝐔𝐒𝐈𝐂 𝐋𝐎𝐕𝐄𝐑𝐒🎸\n\n  ⫸𝑺𝒐𝒏𝒈𝒆:- {rip_data['title']}\n  ⫸𝐁𝐲:- {rip_data['uploader']}\n  ⫸𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑳𝒊𝒏𝒌:- @AS_M_usic_lover\n\n       [▓►»»𝗝𝗢𝗜𝗡 𝗡𝗢𝗪««◄▓](https://t.me/AS_M_usic_lover)\n\n 🔅 ⃟ ▬▬▬▬▬▬▬▬▬▬ ⃟ 🔅\n"
